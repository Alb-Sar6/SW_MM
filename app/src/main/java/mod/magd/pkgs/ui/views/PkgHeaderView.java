...
// USAGE:
//   PkgHeaderView pkgHeader = new PkgHeaderView(this);
//   pkgHeader.setPackage(activePackage);
//   pkgHeader.setActionListener(new PkgHeaderView.OnPackageActionListener() {
//       @Override
...
public final class PkgHeaderView extends LinearLayout {
    ...
    /**
     * Create a new PkgHeaderView component.
     *
     * @param context Application context
     */
    public PkgHeaderView(Context context) {
        super(context);
        initializeView();
    }
