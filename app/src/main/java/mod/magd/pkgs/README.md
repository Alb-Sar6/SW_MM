   ...
   - Shows two buttons: **"Switch"** and **"Manage"**
    ...
    1- **If user taps "Switch"** 
      ...
      - `ManageJavaActivity` updates:
        ...
        - `PkgHeaderView` (at the top) updates to reflect new active package
      
    2- **If User taps "Manage"** 
